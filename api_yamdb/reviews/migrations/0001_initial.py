    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('text', models.TextField(verbose_name='Текст')),
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Значение не может быть меньше {value}'), django.core.validators.MaxValueValidator(10, message='Значение не может быть больше {value}')], verbose_name='Рейтинг')),
            ],
            options={
                'verbose_name': 'Отзыв',
